UNLOCK TABLES;
CREATE DATABASE IF NOT EXISTS `active_v2`;
USE active_v2;
SET TIME_ZONE='-05:00';
...
INSERT INTO `language` (`ID`, `title`) VALUES ("En", "English");
INSERT INTO `language` (`ID`, `title`) VALUES ("Fr", "French");

INSERT INTO `city` (`title`) VALUES ("Ottawa");
INSERT INTO `city` (`title`) VALUES ("Toronto");